...
|   |-- __init__.py
|   |-- test_sandbox.py         # 124 tests: blocked patterns (30), allowed cmds (13), working dir (4), pip mapping (6), import parsing (7), interpreter blocking (7), find blocking (5), encoding bypass (3), home move blocking (4), dotfile protection (9), env filtering (6), traceback extraction (4), pipe-to-shell (6), eval (2), bash string splitting (4), code scanner (14)
|   |-- test_auditor.py         # 12 tests: JSON extraction edge cases
|   |-- test_executor.py        # 14 tests: markdown extraction, timeout estimation
